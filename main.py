...
def attack(char_name: str, char_class: str) -> str:
    """Функция рассчитывает наносимый урон игроком
...
def defence(char_name: str, char_class: str) -> str:
    """Функция рассчитывает заблокированный урон игроком
    в зависимости от выбранного класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция рассчитывает применение специального навыка
    в зависимости от выбранного класса."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция тренировки в зависимости от выбранного класса."""
    if char_class == 'warrior':
